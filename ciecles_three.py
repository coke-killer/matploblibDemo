...
draw.text((145, 37), '总用电量(KWh)', font=font, fill=(166, 108, 90), fontweight='bold')
draw.text((407, 37), '日平均用电量(KWh)', font=font, fill=(199, 188, 233))
draw.text((722, 37), '总电费(RMB)', font=font, fill=(51, 132, 217))
...
cv2.waitKey()
#  保存图片
cv2.imencode('.jpg', bk_png)[1].tofile("plot_folder_user/图片.png")
